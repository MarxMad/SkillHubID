...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CBD5QYDRAFFB2SP2TTPANVX44EHLNHXZOKUIOFMTITQKRVC3N54WP2NK";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        register_user: (json: string) => AssembledTransaction<null>;
        get_role: (json: string) => AssembledTransaction<Option<string>>;
    };
}
