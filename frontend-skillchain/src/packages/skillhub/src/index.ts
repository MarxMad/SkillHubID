...
export interface Client {
   ...
   */
  register_user: ({user, role}: {user: string, role: string}, options?: {
    /**
   ...
   */
  get_role: ({user}: {user: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAANcmVnaXN0ZXJfdXNlcgAAAAAAAAIAAAAAAAAABHVzZXIAAAATAAAAAAAAAARyb2xlAAAAEQAAAAA=",
        "AAAAAAAAAAAAAAAIZ2V0X3JvbGUAAAABAAAAAAAAAAR1c2VyAAAAEwAAAAEAAAPoAAAAEQ==" ]),
      options
    )
  }
  public readonly fromJSON = {
    register_user: this.txFromJSON<null>,
        get_role: this.txFromJSON<Option<string>>
  }
}